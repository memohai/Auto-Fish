...
object TextInputTools {
    fun register(
        ...
        toolRouter: com.memohai.autofish.services.system.ToolRouter? = null,
    ) {
    ...
    private fun registerPressKey(server: Server, executor: ActionExecutor, toolRouter: com.memohai.autofish.services.system.ToolRouter?) {
        server.addTool(
            name = "autofish_press_key",
